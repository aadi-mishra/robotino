...
######################################################
    ...
    #####################################################
        ...
        self.ticks_per_meter = rospy.get_param('ticks_meter', 31828)
    ...
    #####################################################
        ...
        #if ((self.motor_previous > 0 and self.motor < 0) or (self.motor_previous < 0 and self.motor > 0)):
        #    self.motor = 0 
        ...
        # if ((self.motor_previous > 0 and self.motor < 0) or (self.motor_previous < 0 and self.motor > 0)):
        #      self.motor = self.motor_previous
        
        #self.motor_previous =  self.motor
